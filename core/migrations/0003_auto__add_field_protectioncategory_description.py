...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProtectionCategory.description'
        db.add_column('core_protectioncategory', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProtectionCategory.description'
        db.delete_column('core_protectioncategory', 'description')
