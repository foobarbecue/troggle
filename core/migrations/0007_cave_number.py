...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cave.number'
        db.add_column('core_cave', 'number', orm['core.cave:number'])
        
        # Deleting field 'Cave.kataster_number'
        db.delete_column('core_cave', 'kataster_number')
        
        # Creating unique_together for [official_name] on Cave.
        db.create_unique('core_cave', ['official_name'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [official_name] on Cave.
        db.delete_unique('core_cave', ['official_name'])
        
        # Deleting field 'Cave.number'
        db.delete_column('core_cave', 'number')
        
        # Adding field 'Cave.kataster_number'
        db.add_column('core_cave', 'kataster_number', orm['core.cave:kataster_number'])
