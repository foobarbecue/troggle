...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Cave.protection_category' to match new field type.
        #db.rename_column('core_cave', 'protection_category_id', 'protection_category')
        # Changing field 'Cave.protection_category'
        db.alter_column('core_cave', 'protection_category', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Removing index on 'Cave', fields ['protection_category']
        #db.delete_index('core_cave', ['protection_category_id'])


    def backwards(self, orm):
        
        # Adding index on 'Cave', fields ['protection_category']
        db.create_index('core_cave', ['protection_category_id'])
        ...
        # Renaming column for 'Cave.protection_category' to match new field type.
        db.rename_column('core_cave', 'protection_category', 'protection_category_id')
        # Changing field 'Cave.protection_category'
        db.alter_column('core_cave', 'protection_category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ProtectionCategory'], null=True))
    ...
    models = {
        ...
        'core.cave': {
            ...
            'protection_category': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
