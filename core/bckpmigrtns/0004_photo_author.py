...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.taken_by'
        db.add_column('core_photo', 'taken_by', orm['core.photo:taken_by'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Photo.taken_by'
        db.delete_column('core_photo', 'taken_by_id')
