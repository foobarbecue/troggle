...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.taken_by'
        # (to signature: django.db.models.fields.related.ForeignKey(blank=True, null=True, to=orm['core.Person']))
        db.alter_column('core_photo', 'taken_by_id', orm['core.photo:taken_by'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Photo.taken_by'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.PersonTrip'], null=True, blank=True))
        db.alter_column('core_photo', 'taken_by_id', orm['core.photo:taken_by'])
