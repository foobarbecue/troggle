...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'survey.rendered_image'
        db.delete_column('core_survey', 'rendered_image')

        # Adding field 'Cave.number'
        db.add_column('core_cave', 'number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'survey.rendered_image'
        db.add_column('core_survey', 'rendered_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
