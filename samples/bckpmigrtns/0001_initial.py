...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('samples_sample', (
            ...
            ('new_since_parsing', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('non_public', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('material', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('part_of', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Sample'], null=True, blank=True)),
            ('distance_from_bottom', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('logbook_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.LogbookEntry'], null=True, blank=True)),
            ('d18O', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('d2H', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
