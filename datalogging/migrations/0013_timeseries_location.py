...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Timeseries.location_in_cave'
        db.add_column('datalogging_timeseries', 'location_in_cave', orm['datalogging.timeseries:location_in_cave'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Timeseries.location_in_cave'
        db.delete_column('datalogging_timeseries', 'location_in_cave')
