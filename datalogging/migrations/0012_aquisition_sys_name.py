...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataAquisitionSystem.name'
        db.add_column('datalogging_dataaquisitionsystem', 'name', orm['datalogging.dataaquisitionsystem:name'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'DataAquisitionSystem.name'
        db.delete_column('datalogging_dataaquisitionsystem', 'name')
