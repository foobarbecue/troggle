...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EquipmentType.voltage'
        db.add_column('datalogging_equipmenttype', 'voltage', orm['datalogging.equipmenttype:voltage'])
        ...
        # Adding field 'EquipmentType.manual'
        db.add_column('datalogging_equipmenttype', 'manual', orm['datalogging.equipmenttype:manual'])
        ...
        # Adding field 'EquipmentType.current'
        db.add_column('datalogging_equipmenttype', 'current', orm['datalogging.equipmenttype:current'])
        
        # Deleting field 'EquipmentType.power'
        db.delete_column('datalogging_equipmenttype', 'power')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EquipmentType.voltage'
        db.delete_column('datalogging_equipmenttype', 'voltage')
        
        # Dropping ManyToManyField 'DataAquisitionSystem.component'
        db.delete_table('datalogging_dataaquisitionsystem_component')
        
        # Deleting field 'EquipmentType.manual'
        db.delete_column('datalogging_equipmenttype', 'manual')
        
        # Deleting field 'EquipmentType.capacity'
        db.delete_column('datalogging_equipmenttype', 'capacity')
        
        # Deleting field 'EquipmentType.current'
        db.delete_column('datalogging_equipmenttype', 'current')
        
        # Adding field 'EquipmentType.power'
        db.add_column('datalogging_equipmenttype', 'power', orm['datalogging.equipmenttype:power'])
